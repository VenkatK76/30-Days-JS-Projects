document.addEventListener("DOMContentLoaded", () => {
    ...
    investmentInput.addEventListener("input", (event) => {
        updateInvestmentValue(event.target.value);
    });
    interestRateInput.addEventListener("input", (event) => {
        updateInterestRateValue(event.target.value);
    });
    timePeriodInput.addEventListener("input", (event) => {
        updateTimePeriodValue(event.target.value);
    });
